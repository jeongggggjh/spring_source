...
public class TestController {
	...
	public ModelAndView abc() {
		...
		// return new ModelAndView("list", "msg", "ㅎㅇ? jsp");
		
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("list");
		// request.setAttribute("msg", "ㅎㅇ? jsp");
		// HttpServletRequest를 사용해 키, 값으로 jsp에 전송
		modelAndView.addObject("msg", "ㅎㅇ? jsp");
		return modelAndView;
	}
	...
	@GetMapping("test3") // get, post 모두 처리
	public ModelAndView abc3() {
		return new ModelAndView("list", "msg", "성공3");
	}
	
	@GetMapping("test4") // get, post 모두 처리
	public String abc4(Model model) {
		model.addAttribute("msg", "성공4");
		return "list";
	}
	
	@RequestMapping(value="test5", method=RequestMethod.POST) // get 요청 처리
